...
<?php $APPLICATION->IncludeComponent(
    ...
    array(
        ...
        "DETAIL_PROPERTY_CODE" => array(
            0 => "PROIZVODITEL",
            1 => "VES_V_KG",
            2 => "MATERIAL_IZGOTOVLENIYA",
			3 => "STRANA_PROIZVODITEL",
			4 => "BLOW_BACK",
			5 => "VERSIYA_GIRBOKSA",
			6 => "VERSIYA_GIRBOKSA_1",
			7 => "VES_AVTOMATA_V_KG",
			8 => "VNUTRENNIY_STVOLIK",
			9 => "DLINA_",
			10 => "KOL_VO_V_UPAKOVKE",
			11 => "KOL_VO_V_UPAKOVKE_1",
			12 => "MAGAZIN",
			13 => "MATERIAL",
			14 => "MOTOR",
			15 => "OBEM_MAGAZINA",
			16 => "PEREVOZCHIK",
			17 => "PODSHIPNIKI",
			18 => "PRINTSIP_DEYSTVIYA",
			19 => "PRINTSIP_DEYSTVIYA_1",
			//20 => "PROIZVODITEL",
			21 => "SERIYA",
			22 => "SERIYA_",
			23 => "SKOROST_VYLETA_SHARA",	
			24 => "SOVMESTIMOST",	
			25 => "SOVMESTIMOST_1",	
			26 => "SOVMESTIMOST_2",
			27 => "TIP_AKB",
